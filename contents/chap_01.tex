...
\begin{problem}[思考题 1]\label{exer:think_01_intro_01}
请简述新能源与可再生能源的主要区别？
\end{problem}
...
\begin{problem}[思考题 2]\label{exer:think_01_intro_02}
什么是能源弹性系数，请给出其数学表达式？
\end{problem}
...
\end{equation*}
\begin{itemize}
\item \textbf{式中含义}：\(e\) 为能源消费(生产)弹性系数；\(\alpha\) 为能源消费(生产)增长率；\(\beta\) 为国内生产总值增长率；\(\Delta E\) 为计算期间的能源消费(生产)增量；\(E_{0}\) 为计算起始年的能源消费(生产)量；\(\Delta G\) 为计算期间的国内生产总值增量；\(G_{0}\) （或 \(G\)）为计算起始年的国内生产总值 。
\end{itemize}
\end{solution}

% source: docs/review_questions.md | chapter=1. 绪论 | question=3
\begin{problem}[思考题 3]\label{exer:think_01_intro_03}
...
\begin{problem}[思考题 4]\label{exer:think_01_intro_04}
常见的能源环境污染分为哪几种？
\end{problem}
...
\begin{problem}[思考题 5]\label{exer:think_01_intro_05}
请简述改善能源环境污染的主要途径。
\end{problem}
...
\begin{problem}[思考题 6]\label{exer:think_01_intro_06}
...
\begin{problem}[思考题 7]\label{exer:think_01_intro_07}
...
\begin{problem}[思考题 8]\label{exer:think_01_intro_08}
举例说明你所熟悉的新能源发电技术？
\end{problem}
...
\begin{problem}[思考题 9]\label{exer:think_01_intro_09}
新能源渗透率如何定义？
\end{problem}
...
\begin{problem}[思考题 10]\label{exer:think_01_intro_10}
